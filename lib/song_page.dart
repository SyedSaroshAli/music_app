...
class SongPlayer extends StatefulWidget {
  ...
  final int index; 
  const SongPlayer({super.key, required this.name, required this.artistName, required this.imagePath, required this.songPath, required this.index});
...
class _SongPlayerState extends State<SongPlayer> {
  ...
  void playSong()async{
    if(_isPlaying==true){
      ...
      await player.play(AssetSource(playlist[currentIndex!]['SongPath']));
      setState(() {
        _isPlaying= true;
      });
    }
    ...
    return Scaffold(
      body: Stack(
        children:[ Container(
         ...
         child: Image.asset(playlist[currentIndex!]['ImagePath'],
         height: MediaQuery.of(context).size.height,
         width: MediaQuery.of(context).size.width,
         fit: BoxFit.cover,),
        ),
           ...
           child: Padding(
             ...
             child: Column(
               ...
               children: [
                 ...
                 Text('By ${playlist[currentIndex!]['Artist']}',
                 style: TextStyle(
                  fontWeight: FontWeight.bold,
