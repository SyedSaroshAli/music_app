...
import 'package:flutter/material.dart';
import 'package:music_player/fav_song_player.dart';
import 'package:music_player/widgets/favourite_song_provider.dart';
import 'package:provider/provider.dart';

class SongTiles2 extends StatefulWidget {
  final String name, imagePath, artistName, songPath;
  final int index;
  ...
  @override
  State<SongTiles2> createState() => _SongTilesState();
}

class _SongTilesState extends State<SongTiles2> {
  bool isSelected = false;
